...
#define 所提供的参数超出长度限制 u8"太长了！"
#define 所绑定的用户已被bacho封禁 u8"你的账户已经被bancho ban掉了，请先解绑再绑定你要的账户。"
#define 未从bancho检索到要查询的用户信息 u8"没这个人！"
#define 用户没有绑定osu账号 u8"你还没有绑定你的账户，请使用! setid id来绑定~"
#define 被查询的用户未绑定osu账号 u8"ta还没有绑定他的账户，请让ta使用 ! setid id来绑定哦——"
#define 被查询的用户已被bancho封禁 u8"被办了。"
...
#define 没有查询到BP u8"你还没有这么多bp呢！"
#define 没有查询到他人BP u8"他还没有这么多bp呢！"
